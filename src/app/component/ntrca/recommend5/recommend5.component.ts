...
export class Recommend5Component implements OnInit, OnDestroy {
  baseUrl: string = `${environment.apiUrl}/recommend5/`
  ...
  /** Breaks at space before the word containing the 24th character. Returns up to 3 lines (second line broken again if > 24 chars). */
