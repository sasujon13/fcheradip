...
export class Vacant7Component implements OnInit {
  baseUrl: string = 'https://cheradip.com/api/vacant/'
  ...
  getVacancies(page: number): void {
    ...
    this.http.get(`${this.baseUrl}`, { params }).subscribe((data: any) => {
      ...
      this.recordRange = `Displaying <b>${startRecord}-${endRecord}</b> records of <b>${this.totalCount}</b> of total 58,415 Records!`;
