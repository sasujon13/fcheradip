...
export class CreatedQuestionsComponent implements OnInit, AfterViewInit {
  ...
  private exportPayloadFromSavedSet(set: CreatedQuestionSet): Record<string, unknown> {
    ...
    const out: Record<string, unknown> = {
      ...
      previewQuestionsFontPxCreative: this.numFromLayout(ls, 'previewQuestionsFontPxCreative', 8),
      previewQuestionsFontPxMcq: this.numFromLayout(ls, 'previewQuestionsFontPxMcq', 8),
